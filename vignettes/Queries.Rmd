...
This vignette provides a summary of the simple and common use of [REDCapDM](https://github.com/ubidi/REDCapDM) to identify discrepancies in [REDCap](https://www.project-redcap.org/) data imported into R.
...
Queries are crucial for the accuracy and reliability of a [REDCap](https://www.project-redcap.org/) dataset. They help identify missing values, inconsistencies, and potential errors in the collected data. The [`rd_query()`](https://ubidi.github.io/REDCapDM/reference/rd_query.html) function allows you to generate queries using a specific expression.
...
For longitudinal projects, the [`rd_event()`](https://ubidi.github.io/REDCapDM/reference/rd_event.html) allows you to check if a particular event is missing from a record in the exported data. This happens in REDCap when there is no collected data in a particular event from a record, as REDCap will not export the corresponding row. To identify these cases, you can use the following code:
...
The [`check_queries()`](https://ubidi.github.io/REDCapDM/reference/check_queries.html) functiona allows you to compare the previous query dataset with the new one:
...
**For more information, consult the complete vignette available at: https://ubidi.github.io/REDCapDM/articles/REDCapDM.html**
