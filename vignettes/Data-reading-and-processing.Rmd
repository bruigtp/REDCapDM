...
This vignette provides a summary of the straightforward and common use of [REDCapDM](https://github.com/ubidi/REDCapDM) to interact with [REDCap](https://www.project-redcap.org/) data.

<br>

# **Read data**

To import data from [REDCap](https://www.project-redcap.org/), you can use the [`redcap_data()`](https://ubidi.github.io/REDCapDM/reference/redcap_data.html) function, which provides two primary methods: importing data from local files or establishing an API connection.
...
The [`redcap_data()`](https://ubidi.github.io/REDCapDM/reference/redcap_data.html) function returns a list with three elements:
...
Having successfully imported our data into R, you can now use the [`rd_transform()`](https://ubidi.github.io/REDCapDM/reference/rd_transform.html) function to start processing the data.
